...
export class Backend implements backendInterface {
    ...
    async assignModulesToUser(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignModulesToUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createAppUser(arg0: string, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createModule(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createModule(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAssignments(): Promise<Array<UserAssignment>> {
        if (this.processError) {
            try {
    ...
    async getAllCompletions(): Promise<Array<CompletionRecord>> {
        if (this.processError) {
            try {
    ...
    async getAppUser(arg0: string): Promise<AppUser | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppUser(arg0);
    ...
    async getAssignmentsForUser(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getCompletionsByModule(arg0: bigint): Promise<Array<CompletionRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletionsByModule(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getModule(arg0: bigint): Promise<TrainingModule | null> {
        if (this.processError) {
            try {
    ...
    async getModuleCategories(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getModuleCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getModules(): Promise<Array<TrainingModule>> {
        if (this.processError) {
            try {
    ...
    async getMyCompletions(): Promise<Array<CompletionRecord>> {
        if (this.processError) {
            try {
    ...
    async hasCompletedModule(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasCompletedModule(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerGoogleUser(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.registerGoogleUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setModuleCategory(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setModuleCategory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitCompletion(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateAppUserPermission(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAppUserPermission(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateModule(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateModule(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AppUser]): AppUser | null {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TrainingModule]): TrainingModule | null {
    return value.length === 0 ? null : value[0];
}
